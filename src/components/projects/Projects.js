...
<br/>
  ...
  <div className="card h-100  bg-dark cardInfo">
    <div className="card-body">
      ...
      <hr/>
      <p className="card-text">Simple Wallet <br/> React + Bootstrap</p>
    </div>
    <div className="card-footer">
  ...
  <div className="card h-100  bg-dark cardInfo">
    <div className="card-body">
      ...
      <hr/>
      <p className="card-text">Github profile finder. <br/> React + Bootstrap + Github API</p>
    </div>
    <div className="card-footer">
  ...
  <div className="card h-100  bg-dark cardInfo hover-shadow">
    <div className="card-body">
      ...
      <hr/>
      <p className="card-text">Personal Todo app with an edit and delete options. <br/> React + Bootstrap + FontAwesome</p>
    </div>
    <div className="card-footer">
